export const Heroes = [
    ...
    },
    {
      id: "metalknight",
      name: "Metal knight",
      photo: require("./metalknight.jpeg"),
      quote: "Dr. Bofoi",
      description:
    ...
    { id: "king", name: "King", photo: require("./king.jpeg") },
    {
      id: "atomicsamurai",
      name: "Atomic samurai",
      photo: require("./atomicsamurai.jpeg")
    },
    {
      id: "puripuri",
      name: "Puri Puri",
